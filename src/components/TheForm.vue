<template>
  <form @submit.prevent="submitForm">
    <div
      class="form-control"
      :class="{ invalid: userNameIsValidity === 'invalid' }"
    >
      ...
      />
      <p v-if="userNameIsValidity === 'invalid'">Please enter a valid name!</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    validateUserName() {
      if (this.userName === "") {
        this.userNameIsValidity = "invalid";
      } else {
        this.userNameIsValidity = "valid";
      }
    }
  }
};
